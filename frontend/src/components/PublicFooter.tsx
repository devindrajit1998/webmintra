  ...
  return (
    <footer className="border-t border-[#e2e8f0] bg-white py-8 text-center text-xs text-[#64748b]">
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-6 sm:flex-row">
        ...
        >
          <Link to="/privacy-policy" className="hover:text-[#059669] hover:underline">
            Privacy
          </Link>
          <Link to="/terms-and-conditions" className="hover:text-[#059669] hover:underline">
            Terms
          </Link>
          <Link to="/refund-cancellation-policy" className="hover:text-[#059669] hover:underline">
            Refund Policy
          </Link>
