      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-2 text-sm text-slate-400">
            Manage, edit, and publish all your workspaces.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          ...
          <button
            type="button"
            className="hidden sm:flex items-center justify-center rounded-xl border border-slate-700/80 bg-slate-900/50 p-2.5 text-slate-400 hover:text-white transition"
          >
    ...
    <article className="group overflow-hidden rounded-2xl border border-slate-800 bg-slate-900/40 shadow-xl backdrop-blur-sm transition-all hover:-translate-y-1 hover:border-cyan-500/30 hover:shadow-[0_8px_30px_rgba(6,182,212,0.1)] flex flex-col h-full">
      ...
      <div className="relative h-40 overflow-hidden bg-[linear-gradient(125deg,#0f766e,#0e7490_48%,#312e81)]">
        ...
        <div className="absolute top-3 left-3 right-3 flex justify-between items-start">
          ...
          <button
            type="button"
            className="rounded-md p-1.5 text-white/70 hover:bg-slate-950/40 hover:text-white backdrop-blur-md transition opacity-0 group-hover:opacity-100"
          >
      ...
      <div className="flex flex-col flex-1 p-5">
        <div className="min-w-0 flex-1">
          <h3 className="truncate font-display text-lg font-bold text-white group-hover:text-cyan-300 transition-colors">
            {website.name}
          </h3>
          ...
          {url ? (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-3 flex items-center gap-1 text-[11px] text-slate-400 hover:text-cyan-400 transition-colors w-fit"
            >
        ...
        <div className="mt-6 flex items-center gap-2 pt-4 border-t border-slate-800/60">
          ...
          <button
            type="button"
            className="flex items-center justify-center rounded-xl border border-slate-700/50 bg-slate-800/20 p-2 text-slate-400 hover:border-slate-600 hover:bg-slate-700 hover:text-white transition"
            aria-label="Settings"
          >
