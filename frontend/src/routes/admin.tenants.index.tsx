...
import { getTenants, createTenant, updateTenantStatus, deleteTenant, updateTenant, impersonateTenant } from "@/lib/admin-api";
                    ...
                    <td className="px-6 py-4">
                      <Link to="/admin/tenants/$id" params={{ id: tenant.id }} className="flex items-center gap-3 group">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-slate-500">{tenant.name} Â· {tenant.email}</p>
                        </div>
                      </Link>
                    </td>
                    <td className="px-6 py-4">
